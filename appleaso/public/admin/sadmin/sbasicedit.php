...
$query = getDB()->query("SELECT * FROM " . tableex('str') . " where id='$id' and inputkind>0");
...
<div id="UMain">
    <!-- 当前位置 -->
    <div id="urHere"><em class="homeico"></em>后台管理<b>&gt;</b><strong>栏目配置</strong></div>
    <div id="mainBox">
        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                ...
                <tr>
                    <td width="10%" align="right">变量名</td>
                    <td align="left"><input type="text" name="strname" value="<?php echo(htmlspecialchars($link['strname'])); ?>" class="inputtext">
                        <label><input type="checkbox" name="ifadmin" value="0" <?php if ($link['ifadmin'] == 1) {
                                echo('checked');
                            } ?>>管理员变量</label>
                        <?php
                        if ($link['strcid'] > 0) {
                            ?>
                            <label style="display:none"><input type="checkbox" name="ifbind" value="0" <?php if ($link['ifbind'] == 1) {
                                    echo('checked');
                                } ?>>绑定到栏目值</label>
                            <?php
                        }
                ...
                <tr>
                    <td width="10%" align="right">变量类型</td>
                    <td align="left">
                ...
                <tr id="moresetting1" class="input_moresetting" style="display:<?php echo($moresetting1); ?>">
                    <td width="10%" align="right">变量数据来源</td>
                    <td align="left">
                ...
                <tr id="moresetting2" class="input_moresetting" style="display:<?php echo($moresetting2); ?>">
                    <td width="10%" align="right">变量配置</td>
                    <td align="left">
                ...
                <tr>
                    <td width="10%" align="right">数据校验正则</td>
                    <td align="left">
                        <input type="text" id="sregular" name="ssetting[regular]" size="40" value="<?php if (isset($ssetting['regular'])) {
                            echo(htmlspecialchars($ssetting['regular']));
                        } else {
                            $ssetting['regular'] = '';
                        } ?>" class="inputtext">
                        <select name="pattern_select" onchange="javascript:$('#sregular').val(this.value)">
                            <option<?php if ($ssetting['regular'] == '') {
                                echo(' selected');
                            } ?> value="">常用正则
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^[0-9.-]+$/') {
                                echo(' selected');
                            } ?> value="/^[0-9.-]+$/">数字
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^[0-9-]+$/') {
                            ...
                            <option<?php if ($ssetting['regular'] == '/^[a-z]+$/i') {
                                echo(' selected');
                            } ?> value="/^[a-z]+$/i">字母
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^[0-9a-z]+$/i') {
                                echo(' selected');
                            } ?> value="/^[0-9a-z]+$/i">数字+字母
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^[\w\-\.]+@[\w\-\.]+(\.\w+)+$/') {
                                echo(' selected');
                            } ?> value="/^[\w\-\.]+@[\w\-\.]+(\.\w+)+$/">E-mail
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^[0-9]{5,20}$/') {
                                echo(' selected');
                            } ?> value="/^[0-9]{5,20}$/">QQ
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^http:\/\//') {
                                echo(' selected');
                            } ?> value="/^http:\/\//">超级链接
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^(1)[0-9]{10}$/') {
                                echo(' selected');
                            } ?> value="/^(1)[0-9]{10}$/">手机号码
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^[0-9-]{6,13}$/') {
                                echo(' selected');
                            } ?> value="/^[0-9-]{6,13}$/">电话号码
                            </option>
                            <option<?php if ($ssetting['regular'] == '/^[0-9]{6}$/') {
                                echo(' selected');
                            } ?> value="/^[0-9]{6}$/">邮政编码
                            </option>
                            <option<?php if ($ssetting['regular'] == '/(.*)$/') {
                ...
                <tr>
                    <td width="10%" align="right">长度限制</td>
                    <td align="left">
                        最短 <input type="text" name="ssetting[lenmin]" size="10" value="<?php if (isset($ssetting['lenmin'])) {
                            echo(intval($ssetting['lenmin']));
                        } ?>" class="inputtext">
                        最长 <input type="text" name="ssetting[lenmax]" size="10" value="<?php if (isset($ssetting['lenmax'])) {
                            echo(intval($ssetting['lenmax']));
                        } ?>" class="inputtext">
                        <i>不填则不限制</i>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="10%" align="right">输入提示</td>
                    <td align="left">
                ...
                <tr>
                    <td width="10%" align="right">HTML代码设置</td>
                    <td align="left">
                        <select name="ssetting[filterhtml]">
                            <option value="0" <?php if (!isset($ssetting['filterhtml'])) {
                                echo(' selected');
                            } ?>>HTML代码设置
                            </option>
                            <option value="0" <?php if (isset($ssetting['filterhtml']) && $ssetting['filterhtml'] == 0) {
                                echo(' selected');
                            } ?>>允许HTML代码
                            </option>
                            <option value="1" <?php if (isset($ssetting['filterhtml']) && $ssetting['filterhtml'] == 1) {
                                echo(' selected');
                            } ?>>过滤危险HTML代码
                            </option>
                            <option value="2" <?php if (isset($ssetting['filterhtml']) && $ssetting['filterhtml'] == 2) {
                                echo(' selected');
                            } ?>>禁用HTML代码
                            </option>
                        </select>
                ...
                <tr>
                    <td width="10%" align="right">输入框style</td>
                    <td align="left">
