...
?>
<input<?php echo($style);?> autocomplete="off" name="<?php echo($inputname);?>" type="text" id="<?php echo($inputname);?>" class="inputtext" size="45" value="<?php echo(($inputvalue));?>" placeholder="【选择文件】或在文本框【粘贴】图片或文件">
<?php
if($sbie) {
?>
