...
$query = getDB() -> query("SELECT * FROM ".tableex('admin')." where id='$id' and alevel<='$alevel' limit 1");
		...
		<tr id="quantr">
			...
			<td  align="left">
				<div id="quan" style="margin-top:20px">
					...
					├──<label><input type="checkbox" name="s[]" id="s_0" value="0"<?php if(power('s',0,$thiuserpower)) {echo(' checked');}?>>系统设置</label><input type="checkbox" name="s_0[]" value="4" checked style="display:none">
					<?php
